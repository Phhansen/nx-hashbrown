...
@Component({
  ...
  template: `
    ...
    @for (suggestion of suggestions(); track $index) { @switch (suggestion.type)
    { @case ('Create Scene') {
    <div class="suggestion">
      ...
      <p>
        ...
        >" with
        <span class="suggestionValue">{{ suggestion.lights.length }}</span>
        lights
      </p>
      <div class="suggestionActions">
        <button class="rejectSuggestion" (click)="removeSuggestion($index)">
          Dismiss
        </button>
        <button
    ...
    getLight(suggestion.lightId)(); @let scene = getScene(suggestion.sceneId)();
    ...
    <div class="suggestion">
      ...
      <p>
        Remove Light "<span class="suggestionValue">{{ light?.name }}</span
        >" from Scene "<span class="suggestionValue">{{ scene?.name }}</span
        >"
      </p>
      <div class="suggestionActions">
        <button class="rejectSuggestion" (click)="removeSuggestion($index)">
        ...
        <button
          class="acceptSuggestion"
          (click)="
            removeLightFromScene($index, suggestion.lightId, suggestion.sceneId)
          "
        >
          Accept
        </button>
